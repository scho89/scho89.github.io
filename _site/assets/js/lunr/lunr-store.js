var store = [{
        ...
        "title": "Office 365 post 1",
        "excerpt":"Nested and mixed lists are an interesting beast. It’s a corner case to make sure that Lists within lists do not break the ordered list numbering order Your list styles go deep enough. Ordered – Unordered – Ordered ordered item ordered item unordered unordered unordered2 unordered2 ordered item ordered item...","categories": ["Office365"],
        "tags": ["Exchange Online","Email","Mail flow"],
        "url": "/office365/edge-case-nested-and-mixed-lists/",
        "teaser": null
      },{
        "title": "Office 365 post 1",
        "excerpt":"Nested and mixed lists are an interesting beast. It’s a corner case to make sure that Lists within lists do not break the ordered list numbering order Your list styles go deep enough. Ordered – Unordered – Ordered ordered item ordered item unordered unordered unordered2 unordered2 ordered item ordered item...","categories": [],
        "tags": [],
        "url": "/office-365-test-post/",
        "teaser": null
      },{
        "title": "Office 365 post 1",
        "excerpt":"Nested and mixed lists are an interesting beast. It’s a corner case to make sure that Lists within lists do not break the ordered list numbering order Your list styles go deep enough. Ordered – Unordered – Ordered ordered item ordered item unordered unordered unordered2 unordered2 ordered item ordered item...","categories": [],
        "tags": [],
        "url": "/%EC%9D%B4%EB%9F%B0%EA%B1%B4-%EC%96%B4%EB%96%BB%EA%B2%8C-%EB%82%98%EC%98%A4%EB%82%98/",
        "teaser": null
      },{
        "title": "Foo Bar Identity",
        "excerpt":"\\[x+y=3\\]  ","categories": ["Math"],
        "tags": [],
        "url": "/math/math/",
        "teaser": null
      },{
        "title": "Apps for Microsoft 365 update script",
        "excerpt":"Background It starts from idea of colleague. 업무 특성 상 Office 클라이언트의 업데이트 채널이나 빌드를 변경할 일이 잦았는데, 이를 좀 더 편하게 하고자 만들었었다. 무엇이든지 지나고 나서 보면, 이전 작업에 부족한게 많이 보이기 마련이지요. 민망함을 무릅쓰고 이야기를 적어봅니다. 스크립트를 제작했을 당시 버전의 제 머리(?)를 이용합니다. 임직원의 PC를 관리할 수 있는...","categories": ["en-us","Microsoft365"],
        "tags": ["PowerShell"],
        "url": "/en-us/microsoft365/Update-script/",
        "teaser": null
      },{
        "title": "Defender for Cloud Apps file API \"Insufficient role based permissions\" issue",
        "excerpt":"서론 Microsoft Defender for Cloud Apps alert 및 세부내용 분석을 위한 스크립트를 작성하면서 특정 조건에서 file API가 작동하지 않는것을 확인했습니다. 이곳 저곳 돌아다니며 찾아봤지만 관련 정보를 찾을 수 없었습니다. 혹시 다른이들에게 도움이 될까 하여 글로 남겨둡니다. 증상 application context를 통해 인증한 뒤 file API를 호출하면 권한 오류가 발생합니다. 증상은 list...","categories": ["ko-kr","Microsoft365"],
        "tags": ["Defender for Cloud Apps"],
        "url": "/ko-kr/microsoft365/Defender-for-Cloud-Apps-API-file-permission-error/",
